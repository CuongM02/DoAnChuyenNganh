...
namespace WebBanHang.Controllers
{
    public class GioHangController : Controller
    {
        ...
        //Cap nhat Giỏ hàng
        public ActionResult CapnhatGiohang(int masp, int mas, FormCollection f)
        {

            //Lay gio hang tu Session
            List<GioHangViewModels> lstGiohang = LayGioHang();
            //Kiem tra sach da co trong Session["Giohang"]
            GioHangViewModels sanpham = lstGiohang.SingleOrDefault(n => n.MaSP == masp && n.MaS == mas);
        ...
        //Xoa Giohang
        public ActionResult XoaGiohang(int masp, int mas)
        {
            //Lay gio hang tu Session
            List<GioHangViewModels> lstGiohang = LayGioHang();
            //Kiem tra sach da co trong Session["Giohang"]
            ...
            if (sanpham != null)
            {
                lstGiohang.RemoveAll(n => n.MaSP == masp && n.MaS == mas);
                return RedirectToAction("GioHang");
